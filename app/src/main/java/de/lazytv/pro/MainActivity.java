...
public class MainActivity extends Activity {
 ...
 @Override protected void onCreate(Bundle b){super.onCreate(b);try{if(!ActivationGuard.enforce(this))return;setContentView(R.layout.activity_main);
  ((ImageView)findViewById(R.id.home_logo)).setImageResource(R.drawable.lazytv_official_logo);Base64AssetImage.load(this,(ImageView)findViewById(R.id.playlist_art),"lazytv_playlist.webp.b64");findViewById(android.R.id.content).post(()->{if(!isFinishing()&&(Build.VERSION.SDK_INT<17||!isDestroyed()))loadHomeTiles();});
